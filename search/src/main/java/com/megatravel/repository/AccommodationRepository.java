...
public interface AccommodationRepository extends JpaRepository<Accommodation, Long> {
    ...
    @Query(value = "select * from accommodation qs where  qs.free_to_cancel = true and (qs.category = ?6 or \"all\" = ?6) and qs.id  in" +
            ...
            " having sum(a.capacity) > ?4\n" +
            " )", nativeQuery = true)
    List<Accommodation> advancedSearch(String addressOrCity, String startDate, String endDate, int totalCapacity, long unitTypeId, String category);
